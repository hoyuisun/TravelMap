...
public class Modify_view extends Activity implements ConnectionCallbacks, OnConnectionFailedListener, LocationListener{
	
	private String uriAPI = "http://140.125.45.113/contest/post_mysql/modify_view.php";
	/** 「要更新版面」的訊息代碼 */
	...
	Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case REFRESH_DATA:
				...
				if (result != null)
					// 印出網路回傳的文字
					Toast.makeText(Modify_view.this, "上傳成功", Toast.LENGTH_LONG).show();
				break;
			}
		}
	};
