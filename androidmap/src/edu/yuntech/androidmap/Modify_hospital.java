...
public class Modify_hospital extends Activity implements ConnectionCallbacks, OnConnectionFailedListener, LocationListener{
	
	private String uriAPI = "http://140.125.45.113/contest/post_mysql/modify_hospital.php";
	/** 「要更新版面」的訊息代碼 */
	...
	Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case REFRESH_DATA:
				...
				if (result != null)
					// 印出網路回傳的文字
					Toast.makeText(Modify_hospital.this, "上傳成功", Toast.LENGTH_LONG).show();
				break;
			}
		}
	};
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.modify_hospital);
        ...
        submit.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				Thread t = new Thread(new sendPostRunnable(data.getString("id"), name_tw.getText().toString(), site_tw.getText().toString(), 
	...
	class sendPostRunnable implements Runnable {
		String id, name_tw, phone, site_tw, lat, lng;
		// 建構子，設定要傳的字串
		public sendPostRunnable(String id, String name_tw, String site_tw, String phone, String lat, String lng) {
			this.id = id;
		...
		@Override
		public void run() {
			String result = sendPostDataToInternet(id, name_tw, site_tw, phone, lat, lng);
			mHandler.obtainMessage(REFRESH_DATA, result).sendToTarget();
		}

	}

	private String sendPostDataToInternet(String id, String name_tw, String site_tw, String phone, String lat, String lng) {
